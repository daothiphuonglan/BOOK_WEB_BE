package com.example.BOOK_WEB_BE.entity;
...
public class NguoiDung {
    ...
    public NguoiDung(int maNguoiDung, String hoDem, String ten, String tenDangNhap, String matKhau, char gioiTinh, String email, String soDienThoai, String diaChiMuaHang, String diaChiGiaoHang, boolean daKichHoat, String maKichHoat, List<SuDanhGia> danhSachSuDanhGia, List<SachYeuThich> danhSachSachYeuThich, List<Quyen> danhSachQuyen, List<DonHang> danhSachDonhang) {
        this.maNguoiDung = maNguoiDung;
        this.hoDem = hoDem;
        this.ten = ten;
        this.tenDangNhap = tenDangNhap;
